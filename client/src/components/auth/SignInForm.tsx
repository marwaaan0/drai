        ...
        <div className="space-y-8">
          ...
          <div className="relative w-32 h-32 mx-auto">
            ...
            >
              ...
              >
                <LogIn className="w-16 h-16 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white" />
              </motion.div>
            </motion.div>
          ...
          >
            ...
            >
              <p className="text-zinc-400">
                ...
                <a href="/auth/signup" className="text-blue-400 hover:text-blue-300 hover:underline transition-colors">
                  Sign up
                </a>
              </p>
            </motion.div>
